...
#define PS_FAR_AWAY                  0//1
#define PS_NEAR                      1//0

#define CTS_PROXIMITY_LEVEL0         0
#define CTS_PROXIMITY_LEVEL1         1
#define CTS_PROXIMITY_LEVEL2         2
#define CTS_PROXIMITY_LEVEL3         3
#endif
...
extern int cts_register_psenable_callback(void);
...
extern int cts_enable_proximity_mode(struct cts_device *cts_dev);
extern int cts_exit_proximity_mode(struct cts_device *cts_dev);
extern void panel_60hz_check_proximity_mode(bool proximity_mode);
extern void panel_90hz_check_proximity_mode(bool proximity_mode);
extern void panel_90hz_check_proximity_thinning_mode(bool proximity_mode);
#endif

#ifdef CFG_CTS_PALM_DETECT
extern int cts_enable_pocket_mode(struct cts_device *cts_dev);
extern int cts_disable_pocket_mode(struct cts_device *cts_dev);
extern bool cts_is_pocket_enable(struct cts_device *cts_dev);
#endif
