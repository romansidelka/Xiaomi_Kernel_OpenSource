...
extern void panel_60hz_check_gesture_mode(bool gst_mode);
extern void panel_90hz_check_gesture_mode(bool gst_mode);
extern void panel_90hz_check_gesture_thinning_mode(bool gst_mode);
