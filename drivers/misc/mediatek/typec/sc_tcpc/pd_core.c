...
EXPORT_SYMBOL(pd_is_cable_communication_available);
...
EXPORT_SYMBOL(pd_reset_svid_data);
...
EXPORT_SYMBOL(pd_reset_pe_timer);
...
EXPORT_SYMBOL(pd_unlock_msg_output);
